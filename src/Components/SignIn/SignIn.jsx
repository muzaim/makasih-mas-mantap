...
const SignIn = () => {
  return (
    <section
      className="w-full min-h-screen bg-gradient-to-t md:bg-gradient-to-r from-[#0b1437] to-[#212d58] text-white px-5 py-16 lg:py-0 flex justify-center  lg:grid lg:grid-flow-col lg:grid-cols-2 lg:pt-0 lg:h-screen lg:px-0"
      id="sign-in"
    >

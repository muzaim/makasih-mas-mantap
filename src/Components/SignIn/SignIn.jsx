...
const SignIn = () => {
  return (
    <section
      ...
      id="sign-in"
    >
      <div className="w-full sm:w-[70%] md:w-[60%] lg:flex lg:mx-auto">
        <div className="w-full h-full flex flex-col justify-between lg:py-16">
          <a href="/" className="font-thin flex gap-2 items-center mb-10 ">

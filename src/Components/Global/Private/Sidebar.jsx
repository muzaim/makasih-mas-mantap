...
function Sidebar() {
  return (
    <div className="bg-[#111C44] max-h-screen text-white md:block hidden">
      ...
      <div className="my-4 h-[calc(100%-80px)] overflow-y-scroll scrollbar-hide px-2">
        <div className="pl-4 py-3 hover:text-[#7551FF]">
          <Link
            className="flex items-center gap-2 hover:border-r-4 hover:border-[#7551FF] ease-in-out duration-100"
            to="/"
          >
